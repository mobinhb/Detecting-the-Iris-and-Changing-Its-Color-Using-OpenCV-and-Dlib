...
# Load Image
im = cv2.imread("E:\girl.jpg")

# Detect face landmarks
PREDICTOR_PATH = r"E:\shape_predictor_68_face_landmarks.dat"
...
def changeEyeColor(im, irisMask, inverseIrisMask):
    imCopy = cv2.applyColorMap(im, cv2.COLORMAP_SUMMER)
...
rightEyeMask = createEyeMask(landmarks[43:48], im)

# Find the iris by thresholding the red channel of the image within the boundaries of the eye mask
leftIris = findIris(leftEyeMask, im, 33)
rightIris = findIris(rightEyeMask, im, 46)
